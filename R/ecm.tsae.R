#' @title EBLUPs univariate small area estimation using t-distrubiton approach
#' @description This function is used for small area estimation thats have outlier in respons variable
...
#' @param sigma2u number random for first sigma2u, Default \code{0}.
#' @param df number containing the sampling variances of direct estimators for each domain. The values must be sorted as the variables, Default:\code{3}.
